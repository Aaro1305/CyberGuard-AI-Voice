...
with tab_scanner:
    st.markdown("""
        <div style="margin-bottom: 15px;">
            ...
            <p style="color: #64748b; font-size: 14px;">Drop your target audio or video file below to run multi-engine forensic cloning checks.</p>
        </div>
    """, unsafe_allow_html=True)
    ...
    if uploaded_file is not None:
        ...
        if st.button("🚀 Run Deepfake Analysis", type="primary"):
            ...
            if os.path.exists("temp_spectrogram.png"):
                ...
                st.image("temp_spectrogram.png", caption="Generated Frequency Spectrogram", use_container_width=True)
